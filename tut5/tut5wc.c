...
#define XSize 16        // the width  of our font
#define YSize 16        // the height of our font
...
void ScrollMsg (char *Msg, int SizeMsg) {
  ...
  for (loop1 = 0; loop1 &lt; SizeMsg; loop1++) {
         ...
         for (loop3=Location; loop3&lt;Location+YSize; loop3++)
                ...
                memcpy((char *) (VGA+(0+(loop3*320))),(char *) ( VGA+(1+(loop3*320))), 320);
  ...
  for (loop3=Location; loop3&lt;Location+YSize; loop3++)
         ...
         memcpy((char *) (VGA+(loop3*320)),(char *) (VGA+(1+(loop3*320))), 320);
